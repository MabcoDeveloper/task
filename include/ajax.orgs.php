...
class OrgsAjaxAPI extends AjaxController {
    ...
    function delete($id) {
        ...
        elseif ($id == 1) {
            ...
            echo '<script>alert("Permission Denied");$(".close").click();</script>';
        }
    ...
    function addUser($id, $userId=0, $remote=false) {
        ...
        if ($_POST) {
            ...
            $InsertUserToOrgTeamQ = "INSERT INTO `ost_organization__teams` (`org_id`, `user_id`) VALUES (
                '$OrgID', '$UserID'
            )";

            db_query($InsertUserToOrgTeamQ);
