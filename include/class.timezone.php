...
class DbTimezone {
    ...
    static $AMBIGUITIES = array(
        ...
        'Asia/Beirut' =>          array('Asia/Amman', 'Asia/Jerusalem', 'Europe/Helsinki', 'Africa/Cairo', 'Asia/Gaza', 'Europe/Minsk'),
        ...
        'Asia/Baghdad' =>         array('Europe/Minsk', 'Europe/Moscow', 'Asia/Damascus'),
