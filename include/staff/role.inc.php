...
<?php if(isset($_SESSION["roles_page_number"])){
?>
<button type="button"><a href="roles.php?sort=&order=&p=<?php echo $_SESSION["roles_page_number"]; ?>">Back</a></button>
<?php
}
else{
  ?>
  <button type="button"><a href="roles.php">Back</a></button>
  <?php
}