...
<?php if(isset($_SESSION["dep_page_number"])){
?>
<button type="button"><a href="departments.php?sort=&order=&p=<?php echo $_SESSION["dep_page_number"]; ?>">Back</a></button>
<?php
}
else{
  ?>
  <button type="button"><a href="departments.php">Back</a></button>
  <?php
}
