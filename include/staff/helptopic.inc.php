...
<?php if(isset($_SESSION["helptopic_page_number"])){
?>
<button type="button"><a href="helptopics.php?sort=&order=&p=<?php echo $_SESSION["helptopic_page_number"]; ?>">Back</a></button>
<?php
}
else{
  ?>
<button type="button"><a href="helptopics.php">Back</a></button>
  <?php
}
