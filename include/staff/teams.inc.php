        ...
        if ($count) {
            ...
            <tr id="<?php echo $id; ?>">
                ...
                <td style="text-align:right;padding-right:25px">&nbsp;&nbsp;
                    ...
                    <?php } else { 
                        $sql="SELECT  COUNT(`ost_team_user_member`.`user_id`)
                        FROM `ost_team` 
                        INNER JOIN `ost_team_user_member` ON `ost_team_user_member`.`team_id`=`ost_team`.`team_id` WHERE `ost_team`.`team_id`=".$id."
...
if ($count): //Show options..
     ...
     $_SESSION["team_page_number"]=$page ;
?>
